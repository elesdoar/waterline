  ...
  if (s3Q.method === 'find' || s3Q.method === 'findOne') {
    ...
    _.each(s3Q.populates, function(populateCriteria, populateAttribute) {
      ...
      try {
        ...
        var childPk = originalModels[parentAttr.referenceIdentity].schema;
        childPk = childPk[originalModels[parentAttr.referenceIdentity].primaryKey].columnName;
        select.push(childPk);
